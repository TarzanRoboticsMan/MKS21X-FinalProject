...
public class Final {
    ...
    putString(1, 20, screen, "Press enter once finished, press tab to restart.");
		putString(1, 22, screen, "Please wait until around one minute and fifteen seconds have passed, as this");
		putString(1, 23, screen, "is around how long the longest ladders take to generate.");
		...
		while (running) {
          ...
          screen.clear();
            ...
            putString(1, 1, screen, "Your second word is not a valid word, please press tab and try again."); //Ensures user puts in a valid word
					...
					else if (test.findPaths(word1, word2).get(0).getValue().equals("Nope")) {
